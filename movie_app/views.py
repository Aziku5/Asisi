...
from movie_app.serializers import DirectorSerializer, MovieSerializer, ReviewSerializer, MovieDetailSerializer, DirectorDetailSerializer, ReviewDetailSerializer
