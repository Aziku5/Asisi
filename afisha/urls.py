...
from movie_app.views import DirectorAPIView, MovieAPIView, ReviewAPIView, ReviewMovieAPIView, DirectorDetailAPIVIew, MovieDetailAPIVIew, ReviewDetailAPIVIew
